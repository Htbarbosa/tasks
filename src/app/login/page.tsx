            ...
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl">
                ...
                <div className="mt-8">
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
                    >
